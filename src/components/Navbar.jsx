...
const navigation = [
  { name: "Gallary", href: "/gallary", current: true },
                ...
                <div className="flex mr-10 flex-shrink-0 items-center">
                  <Link to="/">
                    <p className="font-bold">
                      <span className="font-extrabold italic subpixel-antialiased line-through hover:overline text-amber-900 text-3xl font-handwriting">
                        K
                      </span>
                      araund
                      <span className="font-extrabold italic subpixel-antialiased line-through hover:overline text-amber-900 text-3xl font-handwriting">
