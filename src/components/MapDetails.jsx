  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center">
        <p className="text-3xl font-bold text-emerald-500 mb-4 mt-4 box-border shadow-md shadow-emerald-400 drop-shadow-xl rounded-md">Map</p>
        <address className="text-2xl font-semibold text-orange-950 mb-4">Karaundi</address>
        <div>
          <iframe
